...
uint256 hashGenesisBlock("0xe270338149f6b1f7c16b8e8e2f5e30b231a5cc89099fef83bd4099034b12a215");
...
const string strMessageMagic = "AmCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // AmCoin: 1 days
static const int64 nTargetSpacing = 60; // AmCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal amcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "AmCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x58d00039599fd802338192b0a6d1bf705dfe50a0d0e4113d6c16c64f455b8818");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "AmCoin: 07/sep/2017 https://t.me/amcoininfo https://amcoin.info/";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1504783535; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 284085;

        if (fTestNet)
        {
            block.nTime    = 1504778130;
            block.nNonce   = 927535;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x2001bf4a5d53a1dfa7a2363bd8195f8358b2b1a38cbf61b6487dab4b9803ebf1"));
